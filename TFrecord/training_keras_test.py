...
history = model.fit([raw_train, qp_train], label_train, validation_data=([raw_test, qp_test], label_test), batch_size=batch_size, callbacks=[TrainValTensorBoard(write_graph=False)], epochs=epochs, verbose=1, class_weight=class_weight)
